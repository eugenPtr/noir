...
```
> <sup><sub><a href="https://github.com/noir-lang/noir/blob/master/noir_stdlib/src/scalar_mul.nr#L8-L13" target="_blank" rel="noopener noreferrer">Source code: noir_stdlib/src/scalar_mul.nr#L8-L13</a></sub></sup>
